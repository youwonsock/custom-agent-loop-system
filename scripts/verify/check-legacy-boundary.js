...
const scanRoots = [
  ...
  "config/agents.json", "config/agents.schema.json", "config/tasks.json", "config/tasks.schema.json",
  "config/workflow.json", "config/workflow.schema.json",
];
...
const workflowSchema = JSON.parse(fs.readFileSync(path.join(root, "config", "workflow.schema.json"), "utf8"));
