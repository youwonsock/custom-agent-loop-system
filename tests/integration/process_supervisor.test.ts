...
import { isInteractiveAccessPrompt, matchesConfiguredPrompt } from "../../src/runtime/process-supervisor";
...
function runFake(
  ...
  const helper = path.join(process.cwd(), "tests", "helpers", "process", "run_supervisor_case.js");
