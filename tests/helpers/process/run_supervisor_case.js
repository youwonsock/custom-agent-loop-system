...
const compiledRoot = path.join(__dirname, "..", "..", "..", ".build", "test-dist", "src");
const { ProcessSupervisor, terminateProcessTreeBounded } = require(path.join(compiledRoot, "runtime", "process-supervisor.js"));
const { checkProcessLiveness } = require(path.join(compiledRoot, "infrastructure", "resilience.js"));
