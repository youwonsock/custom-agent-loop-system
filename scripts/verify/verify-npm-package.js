...
try {
  ...
  for (const required of [
    "dist/core/entrypoints/loop-orchestrator.js",
    "dist/core/runtime/process-supervisor.js",
    "dist/core/tools/provider-conformance.js",
    "config/agents.json",
    "config/agents.schema.json",
    "config/tasks.json",
    "config/tasks.schema.json",
    "config/workflow.json",
    "config/workflow.schema.json",
    "config/protocol_contract.json",
    "config/runtime_defaults.json",
    "scripts/runtime/fix-pty-permissions.js",
  ...
  run(
    "installed CLI smoke",
    process.execPath,
    [path.join(installedRoot, "dist", "core", "entrypoints", "loop-orchestrator.js"), "--help"],
  ...
  run(
    ...
    process.execPath,
    [
      path.join(root, "scripts", "test-support", "bundled-supervisor-smoke-child.js"),
      path.join(installedRoot, "dist", "core", "runtime", "process-supervisor.js"),
      fakeCliPath,
      temporaryRoot,
    ],
    { cwd: temporaryRoot, timeout: 30_000 }
  ...
  run(
    ...
    process.execPath,
    [
      path.join(root, "scripts", "test-support", "pty-smoke-child.js"),
  ...
  run(
    ...
    process.execPath,
    [
      path.join(root, "scripts", "test-support", "verification-process-smoke.js"),
      path.join(installedRoot, "dist", "core", "runtime", "verification-process-runtime.js"),
      temporaryRoot,
    ],
    { cwd: temporaryRoot, timeout: 30_000 }
  );
