...
import { VerificationRunner, createVerificationContract } from "../../src/application/verification-runner";
import { validateVerificationContractDraft } from "../../src/domain/verification";
import type { ArtifactReference } from "../../src/domain/task-result";
import type { VerificationCommandSpec } from "../../src/domain/verification";
import type { VerificationRuntimePort } from "../../src/application/ports/verification-runtime-port";
import type { WorkspaceIntegrityPort, WorkspaceWatch, WorkspaceFingerprint } from "../../src/application/ports/workspace-integrity-port";
import type { ArtifactStorePort } from "../../src/application/ports/artifact-store";
