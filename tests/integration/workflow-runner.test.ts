...
import type { VerificationRunnerResult } from "../../src/application/verification-runner";
import type { AgentTaskRunner } from "../../src/application/agent-task-runner";
import type { NodeExecutionContext } from "../../src/application/node-execution-context";
import type { VerificationRunner } from "../../src/application/verification-runner";
import type { VerificationContractService } from "../../src/application/verification-contract-service";
import { NoopProjection } from "../../src/application/ports/projection";
import type { RunControlCommandPort } from "../../src/application/ports/control-command";
...
async function runnerFixture(nodeId: string): Promise<{
  ...
  reducer: RunReducer;
  aggregate: import("../../src/domain/run-aggregate").RunAggregate;
  bundle: import("../../src/domain/workflow").CompiledWorkflowBundle;
