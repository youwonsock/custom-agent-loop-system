...
export function createRunAggregate(options: CreateRunOptions): RunAggregate {
  ...
  return {
    ...
    context: {
      ...
      planChoices: [],
      selectedVerificationDraft: null,
      requirementEvidence: [],
      failureSummary: null,
      recovery: null,
      convergence: {
        ...
        highestReachedStep: null,
        lastFailedCommandIds: [],
        lastUnsatisfiedRequirementIds: [],
        lastUnresolvedFindingIds: [],
      },
      ...
      latestWorkspaceFingerprint: null,
      verificationCriteriaChanges: [],
