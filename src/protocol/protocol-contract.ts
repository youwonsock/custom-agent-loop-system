import { RootSet } from "../interfaces/cli/root-set";
import { readPackagedConfigJson } from "../config/package-config-root";

const protocolContract = readPackagedConfigJson<{
...
export function createCoreCapabilityHandshake(roots: RootSet): CoreCapabilityHandshake {
  return {
    ...
    implementationVersion: process.env.npm_package_version ?? "8.0.0",
